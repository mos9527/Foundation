...
DDS_OUTPUT_DIR = Path(__file__).resolve().parent.parent / "Editor" / "Render" / "Data" / "ViewLUTs"
VIEW_LUTS_HEADER_PATH = Path(__file__).resolve().parent.parent / "Editor" / "Render" / "Tables" / "ViewLUTs.hpp"
...
def write_view_luts_header(path: Path, views: list[dict], config_path: Path) -> None:
    ...
    for output in LUT_OUTPUTS:
        ...
        lines.append(f"inline constexpr int {output['count_name']} = std::size({output['array_name']});")
        default_index = next(
            (
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Output DDS directory, default: Editor/Render/Data/ViewLUTs",
    )
