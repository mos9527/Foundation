...
*Image: [WaterColor V1 scene](https://github.com/mos9527/Foundation-Resources/tree/master/watercolor) rendered with Foundation Path Tracer `PT`, 4096 spp, Fast preset*

Please check out the [Documentation](https://mos9527.com/Foundation/) for more info. 
