...
void GPUSceneImpl::StartUploads()
{
...
void GPUSceneImpl::ProcessPendingUploads()
{
...
bool GPUSceneImpl::EnsureTLASCapacity(uint32_t totalInstances, bool allowRecreate)
{
    if (totalInstances == 0)
        return true;
