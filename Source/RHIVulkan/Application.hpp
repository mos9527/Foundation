...
namespace Foundation::RHI {
    ...
    public:
        ...
        RHIApplicationScopedObjectHandle<RHIDevice> CreateDevice(RHIDevice::DeviceDesc const& desc, SDL_Window* window) override;
        RHIApplicationScopedObjectHandle<RHIDevice> CreateDevice(RHIDevice::DeviceDesc const& desc)
        {
